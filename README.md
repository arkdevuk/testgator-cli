...
| `plan list` / `get <id>` / `create` / `edit <id>` / `duplicate <sourceId>` | `testgator-cli plan list --project 1` or `--release 5`; `testgator-cli plan create --release 5 --name "Regression" --due-date 2026-08-01T00:00:00+00:00` |
| `question list` / `get <id>` / `create` / `edit <id>` | `testgator-cli question create --plan 12 --name "Can you log in?"` |
| `tester list` / `get <id>` | `testgator-cli tester list --project 1` |
